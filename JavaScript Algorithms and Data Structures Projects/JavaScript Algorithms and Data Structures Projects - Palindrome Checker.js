...
function palindrome(str) {
  let regEx = /[|*_.()/\,:-]|\s+/g;
  let wrongCharOut = str.replace(regEx,"").toLowerCase();
  // console.log(wrongCharOut);
  let palindrome1 = wrongCharOut.split('').reverse().join("").toLowerCase();
  // console.log(palindrome1);
  if (palindrome1===wrongCharOut){
    return true;
  }
  return false;
}
